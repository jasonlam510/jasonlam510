export const panelClass = "flex min-h-screen snap-start items-center px-5 py-6 sm:px-6 lg:px-12";
export const panelInnerClass = "mx-auto w-full max-w-[1200px]";
export const eyebrowClass = "m-0 text-[0.82rem] uppercase tracking-[0.22em] text-text-muted";
